...
${context}
    ...
    // Modello: GPT-OSS 20B (pesi aperti, licenza Apache 2.0, disponibile sul free tier Groq).
    ...
    for (const model of models) {
      const requestBody = {
        ...
        // quindi serve un budget più alto dei vecchi 200 di max_tokens.
      ...
      if (!response.ok) {
        ...
        console.error(`Groq API error (v2, ${model}):`, errorText);
        lastError = {
